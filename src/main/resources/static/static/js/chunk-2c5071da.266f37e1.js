(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-2c5071da"], {
    2017: function (e, t, o) {
        ...
        var s = function () {
            ...
            return o("div", {staticClass: "login-container"}, [o("el-form", {
            ...
            }, [o("div", {staticClass: "title-container"}, [o("h3", {staticClass: "title"}, [e._v("E-School Management System")])]), o("el-form-item", {attrs: {prop: "username"}}, [o("span", {staticClass: "svg-container"}, [o("svg-icon", {attrs: {"icon-class": "user"}})], 1), o("el-input", {
                ref: "username",
                attrs: {placeholder: "User Name", name: "username", type: "text", tabindex: "1", "auto-complete": "on"},
                model: {
                ...
                ref: "verifiCode",
                attrs: {placeholder: "VerifiCode", name: "verifiCode"},
                model: {
            ...
            }, [o("el-radio", {attrs: {label: 1}}, [e._v("Admin")]), o("el-radio", {attrs: {label: 2}}, [e._v("Student")]), o("el-radio", {attrs: {label: 3}}, [e._v("Teacher")])], 1)], 1), o("el-button", {
                staticStyle: {
                    width: "100%",
                    "margin-bottom": "30px"
            ...
            name: "Login", data: function () {
                var e = function (e, t, o) {
                    t.length < 2 ? o(new Error("Username length cannot be less than 2 characters")) : o()
                }, t = function (e, t, o) {
                    t.length < 5 ? o(new Error("Password length cannot be less than 5 characters")) : o()
                };
                return {
                    ...
                    loginRules: {
                        ...
                        verifiCode: [{required: !0, message: "Verification code must be entered"}],
                        userType: [{required: !0, message: "User type must be selected"}]
                    },
                    loading: !1,
