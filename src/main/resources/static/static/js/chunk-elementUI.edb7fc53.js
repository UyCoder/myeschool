(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["chunk-elementUI"], {
    "06f1": function (e, t, n) {
        ...
        t.__esModule = !0, t.default = {
            el: {
                colorpicker: {confirm: "OK", clear: "Reset"},
                datepicker: {
                    now: "Now",
                    today: "Today",
                    cancel: "Cancel",
                ...
                select: {loading: "loading", noMatch: "no matching data", noData: "no data", placeholder: "please select"},
                cascader: {noMatch: "No matching data", loading: "Loading", placeholder: "Please select", noData: "No data yet"},
                pagination: {goto: "Go to", pagesize: "Article/Page", total: "Total {total} Articles", pageClassifier: "Page"},
                messagebox: {title: "Prompt", confirm: "OK", cancel: "Cancel", error: "The input data is invalid!"},
                upload: {deleteTip: "Press the delete key to delete", delete: "Delete", preview: "View image", continue: "Continue to upload"},
                table: {
                ...
                tree: {emptyText: "No data yet"},
                transfer: {
                    noMatch: "No matching data",
                    noData: "No Data",
                    titles: ["List 1", "List 2"],
                    filterPlaceholder: "Please enter search content",
                    noCheckedFormat: "Total {total} items",
                    hasCheckedFormat: "Checked {checked}/{total} items"
                },
                image: {error: "Failed to load"},
                pageHeader: {title: "Back"},
                popconfirm: {confirmButtonText: "OK", cancelButtonText: "Cancel"}
            }
        }
    }, f225: function (e, t, n) {
    }, f3ad: function (e, t, n) {
